...
void main()
{
	...
	if (render_mod == -2)
	{
		// color = vec3(float(gl_InstanceID / 255) / 255, float(gl_InstanceID % 255) / 255, 0.f);
		color = vec3(float((gl_InstanceID / 10000) % 100) / 100, float((gl_InstanceID / 100) % 100) / 100, float((gl_InstanceID) % 100) / 100);
		return;
	}
